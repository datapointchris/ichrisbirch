...
offset anyway is describing the same reading: the offset is dropped and the
reading kept, where converting it would move 19:00 to whatever that instant
reads in some other zone.
"""
