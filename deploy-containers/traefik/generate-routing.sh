...
[[ -z "$LN" ]] && {
  echo "ERROR: vue-paths rule not found in dev/routing.yml" >&2
  exit 1
}
...
[[ -z "$LN" ]] && {
  echo "ERROR: vue-paths rule not found in test/routing.yml" >&2
  exit 1
}
...
[[ -z "$LN" ]] && {
  echo "ERROR: vue-paths rule not found in prod/routing.yml" >&2
  exit 1
}
...
[[ -z "$LN" ]] && {
  echo "ERROR: www vue-paths rule not found in prod/routing.yml" >&2
  exit 1
}
