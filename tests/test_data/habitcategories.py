...
BASE_DATA: list[HabitCategory] = [
    ...
    HabitCategory(
        ...
        completed_habits=[
            HabitCompleted(name='Completed Habit 3 Category 2', complete_date=date(2024, 1, 3)),
        ],
    ),
    HabitCategory(
        name='Category 3',
        ...
        completed_habits=[
            HabitCompleted(name='Completed Habit 1 Category 3', complete_date=date(2024, 1, 1)),
            HabitCompleted(name='Completed Habit 2 Category 3', complete_date=date(2024, 1, 2)),
        ],
    ),
]
