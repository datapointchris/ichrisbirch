...
def test_create_autotask(test_api):
    ...
    response = test_api.post('/autotasks/', json=data)
...
def test_autotask_lifecycle(test_api):
    ...
    assert response_autotask.json()['name'] == data['name']
