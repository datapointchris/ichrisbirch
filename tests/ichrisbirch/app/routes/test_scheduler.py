...
def test_index(insert_jobs_in_test_scheduler, test_app_logged_in_admin):
...
def test_pause_and_resume_job(insert_jobs_in_test_scheduler, test_app_logged_in_admin, test_jobstore, job_id):
    ...
    resume_response = test_app_logged_in_admin.post(
        '/admin/scheduler/', data={'job_id': job_id, 'action': 'resume_job'}
    )
...
@pytest.mark.parametrize('job_id', test_job_ids)
def test_delete_job(insert_jobs_in_test_scheduler, test_app_logged_in_admin, test_jobstore, job_id):
