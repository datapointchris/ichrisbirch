...
class FixtureDiagramRenderer:
    ...
    def __init__(self, analysis_data: dict | None = None):
        ...
        self.colors = {
            'session': {'color': '#add8e6', 'fillcolor': '#e6f7ff'},
            'module': {'color': '#90ee90', 'fillcolor': '#f0fff0'},
            'function': {'color': '#ffb6c1', 'fillcolor': '#fff0f5'},
            'package': {'color': '#d8bfd8', 'fillcolor': '#f5f0f5'},
            'class': {'color': '#ffdead', 'fillcolor': '#fff5e6'},
        }
    ...
    def render_main_fixtures_diagram(self, output_path: str = 'docs/images/generated/fixtures_diagram'):
        """Create a well-designed fixture diagram for the main documentation.
