  ...
  <div class="grid grid--one-column grid--tight">
    <div class="admin-subnav">
      <RouterLink
        ...
        :class="{ 'admin-subnav__link--active': active === 'system' }"
      >
        System Health
      </RouterLink>
      <RouterLink
        to="/admin/scheduler"
        class="admin-subnav__link"
        :class="{ 'admin-subnav__link--active': active === 'scheduler' }"
      >
        Scheduler
      </RouterLink>
      <RouterLink
        to="/admin/users"
        class="admin-subnav__link"
        :class="{ 'admin-subnav__link--active': active === 'users' }"
      >
        Users
      </RouterLink>
      <RouterLink
        to="/admin/config"
        class="admin-subnav__link"
        :class="{ 'admin-subnav__link--active': active === 'config' }"
      >
        Config
      </RouterLink>
      <RouterLink
      ...
      <RouterLink
        to="/admin/design"
        class="admin-subnav__link"
        :class="{ 'admin-subnav__link--active': active === 'design' }"
      >
        Design
      </RouterLink>
      <RouterLink
...
defineProps<{
  active: 'system' | 'scheduler' | 'users' | 'config' | 'smoke' | 'design' | 'autotasks'
}>()
</script>
