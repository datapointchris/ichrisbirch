...
The Vue service starts automatically with `./ops/icbops dev start`. It runs as a Vite dev server on port 5173, proxied through Traefik at `app.docker.localhost`.
